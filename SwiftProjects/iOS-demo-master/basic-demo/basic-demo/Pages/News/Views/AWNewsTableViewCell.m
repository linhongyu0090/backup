...
@implementation AWNewsTableViewCell
...
//        NSLog(@"%@", item.picUrl);
//        UIImage *img = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:item.picUrl]]];
